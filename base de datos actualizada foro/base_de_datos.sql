...
-- Tiempo de generación: 20-09-2024 a las 14:32:58
...
INSERT INTO `publicaciones` (`id`, `id_tema`, `id_usuario`, `contenido`, `fecha`) VALUES
(1, 1, 2, 'lalalala', '0000-00-00 00:00:00'),
(2, 2, 3, 'popopo', '0000-00-00 00:00:00');
...
INSERT INTO `temas` (`id`, `titulo`, `id_categoria`) VALUES
(1, 'Me siento solo', 2),
(2, 'no puedo parar', 1);
...
ALTER TABLE `publicaciones`
  ADD CONSTRAINT `publicaciones_ibfk_1` FOREIGN KEY (`id`) REFERENCES `categorias` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
